 ...
 * Compile :   Fri, 31 Mar 2017 11:57:00 GMT
 * Boucles :   _plugins
 */ 
...
function BOUCLE_pluginshtml_ee514d2506093ad27765800ed4b20be6(&$Cache, &$Pile, &$doublons, &$Numrows, $SP) {
	...
	$command['where'] = 
			...
			array('=', 'paquets.actif', sql_quote(@$Pile[0]['actif'], '', '')))), (@$Pile[0]['constante'] ? sql_in('paquets.constante',sql_quote($in1)) : ''));
...
// Temps de compilation total: 49.442 ms
//
