...
quete_condition_statut('forum.statut','publie,prop','publie',''), 
			array('=', 'forum.id_thread', sql_quote($Pile[$SP]['id_thread'], '', '')), 
			array('NOT', 
...
quete_condition_statut('forum.statut','publie,prop','publie',''), 
			...
			array('=', 'forum.id_objet', sql_quote(@$Pile[0]['id_rubrique'], '', '')))), (!(is_array(@$Pile[0]['id_rubrique'])?count(@$Pile[0]['id_rubrique']):strlen(@$Pile[0]['id_rubrique'])) ? '' : 
			...
			array('=', 'forum.id_objet', sql_quote(@$Pile[0]['id_article'], '', '')))), (!(is_array(@$Pile[0]['id_article'])?count(@$Pile[0]['id_article']):strlen(@$Pile[0]['id_article'])) ? '' : 
			...
			array('=', 'forum.id_objet', sql_quote(@$Pile[0]['id_breve'], '', '')))), (!(is_array(@$Pile[0]['id_breve'])?count(@$Pile[0]['id_breve']):strlen(@$Pile[0]['id_breve'])) ? '' : 
			...
			array('=', 'forum.id_objet', sql_quote(@$Pile[0]['id_syndic'], '', '')))), (!(is_array(@$Pile[0]['id_syndic'])?count(@$Pile[0]['id_syndic']):strlen(@$Pile[0]['id_syndic'])) ? '' : 
...
// Temps de compilation total: 24.487 ms
//
