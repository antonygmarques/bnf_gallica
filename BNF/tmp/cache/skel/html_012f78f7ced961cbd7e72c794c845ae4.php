...
// Temps de compilation total: 11.525 ms
//
...
'<'.'?php echo recuperer_fond( ' . argumenter_squelette('formulaires/dateur/inc-dateur') . ', array(\'heure_pas\' => ' . argumenter_squelette(@$Pile[0]['heure_pas']) . ',
	\'lang\' => ' . argumenter_squelette($GLOBALS["spip_lang"]) . '), array("compil"=>array(\'../prive/formulaires/dater.html\',\'html_012f78f7ced961cbd7e72c794c845ae4\',\'\',18,$GLOBALS[\'spip_lang\'])), _request("connect"));
?'.'>
');
