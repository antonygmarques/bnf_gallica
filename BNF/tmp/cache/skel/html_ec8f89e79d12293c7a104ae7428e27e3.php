...
quete_condition_postdates('documents.date_publication',''), 
			...
			array('=', 'L1.id_objet', sql_quote(@$Pile[0]['id_article'], '', '')))), (!(is_array(@$Pile[0]['id_article'])?count(@$Pile[0]['id_article']):strlen(@$Pile[0]['id_article'])) ? '' : 
			...
			array('=', 'L2.id_objet', sql_quote(@$Pile[0]['id_rubrique'], '', '')))), (!(is_array(@$Pile[0]['id_rubrique'])?count(@$Pile[0]['id_rubrique']):strlen(@$Pile[0]['id_rubrique'])) ? '' : 
			...
			array('=', 'L3.objet', sql_quote(@$Pile[0]['objet'], '', '')))), (!(is_array(@$Pile[0]['id_objet'])?count(@$Pile[0]['id_objet']):strlen(@$Pile[0]['id_objet'])) ? '' : ((is_array(@$Pile[0]['id_objet'])) ? sql_in('L4.id_objet',sql_quote($in3)) : 
			array('=', 'L4.id_objet', sql_quote(@$Pile[0]['id_objet'], '', '')))), 
...
quete_condition_postdates('documents.date_publication',''), 
			...
			array('=', 'documents.id_document', sql_quote(@$Pile[0]['id_document'], '', '')), (!(is_array(@$Pile[0]['id_article'])?count(@$Pile[0]['id_article']):strlen(@$Pile[0]['id_article'])) ? '' : ((is_array(@$Pile[0]['id_article'])) ? sql_in('L1.id_objet',sql_quote($in)) : 
			array('=', 'L1.id_objet', sql_quote(@$Pile[0]['id_article'], '', '')))), (!(is_array(@$Pile[0]['id_article'])?count(@$Pile[0]['id_article']):strlen(@$Pile[0]['id_article'])) ? '' : 
			array('=', 'L1.objet', sql_quote('article'))), (!(is_array(@$Pile[0]['id_rubrique'])?count(@$Pile[0]['id_rubrique']):strlen(@$Pile[0]['id_rubrique'])) ? '' : ((is_array(@$Pile[0]['id_rubrique'])) ? sql_in('L2.id_objet',sql_quote($in1)) : 
			array('=', 'L2.id_objet', sql_quote(@$Pile[0]['id_rubrique'], '', '')))), (!(is_array(@$Pile[0]['id_rubrique'])?count(@$Pile[0]['id_rubrique']):strlen(@$Pile[0]['id_rubrique'])) ? '' : 
			array('=', 'L2.objet', sql_quote('rubrique'))), (!(is_array(@$Pile[0]['objet'])?count(@$Pile[0]['objet']):strlen(@$Pile[0]['objet'])) ? '' : ((is_array(@$Pile[0]['objet'])) ? sql_in('L3.objet',sql_quote($in2)) : 
...
quete_condition_postdates('documents.date_publication',''), 
			...
			array('=', 'L2.objet', sql_quote('rubrique'))), (!(is_array(@$Pile[0]['objet'])?count(@$Pile[0]['objet']):strlen(@$Pile[0]['objet'])) ? '' : ((is_array(@$Pile[0]['objet'])) ? sql_in('L3.objet',sql_quote($in2)) : 
			array('=', 'L3.objet', sql_quote(@$Pile[0]['objet'], '', '')))), (!(is_array(@$Pile[0]['id_objet'])?count(@$Pile[0]['id_objet']):strlen(@$Pile[0]['id_objet'])) ? '' : ((is_array(@$Pile[0]['id_objet'])) ? sql_in('L4.id_objet',sql_quote($in3)) : 
			array('=', 'L4.id_objet', sql_quote(@$Pile[0]['id_objet'], '', '')))), sql_in('documents.extension',sql_quote($in4),'NOT'), 
			array('=', 'L1.vu', "'non'"));
	if (defined("_BOUCLE_PROFILER")) $timer = time()+microtime();
	$t0 = "";
	// REQUETE
...
// Temps de compilation total: 55.217 ms
//
